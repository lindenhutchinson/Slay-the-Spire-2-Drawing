...
class ImageSourcePanel:
    """Detail/thickness/blur/min-contour sliders, simplify toggle, and image load buttons."""
    ...
    def __init__(self, parent, config,
        ...
        self.blur_slider, self.blur_entry, self.blur_var = add_slider(
            wrap, "Blur:", 1, 21, config.blur, on_blur_change,
            tooltip="Pre-edge-detection blur. Higher = smoother edges, less noise. Lower = sharper but noisier.")
